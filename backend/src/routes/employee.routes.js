...
const { create, getById, list, update, predict, history } = require("../controllers/employee.controller");
...
employeeRouter.post("/:id/predict-attrition", authorize(ROLES.MANAGER, ROLES.HR, ROLES.ADMIN), validateParams(idParamsSchema), predict);
employeeRouter.get("/:id/predictions", validateParams(idParamsSchema), history);
